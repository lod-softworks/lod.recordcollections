...
// TODO: IReadOnlyRecordCollection<T>
...
public interface IRecordCollection<T> : IEnumerable, IEnumerable<T>
    , IReadOnlyCollection<T>, ICollection, ICollection<T>
    //, IEquatable<ICollection<T>>, IEqualityComparer<ICollection<T>>
    //, IComparable, IComparable<ICollection<T>>
